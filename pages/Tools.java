...
public class Tools {
    ...
    /**
     * TODO 用于主菜单界面菜单的选择。该方法读取键盘，如果用户键入’1’-’3’中的任意字符，
     * 则方法返回。返回值为用户所键入字符。
     *
     * @author DengChao
    ...
    /**
     * TODO 用于客户信息管理的界面菜单的选择。该方法读取键盘，如果用户键入’1’-’6’中的任意字符，
     * 则方法返回。返回值为用户所键入字符。
     *
     * @author DengChao
     * @date 2022/1/21 15:23
    ...
    /**
     * TODO 用于商品信息管理界面菜单的选择。该方法读取键盘，如果用户键入’1’-’7’中的任意字符，
     * 则方法返回。返回值为用户所键入字符。
     *
     * @author DengChao
     * @date 2022/1/21 15:23
    ...
    /**
     * TODO 用于客户编号的输入判断。该方法从键盘读取一个不超过4位长度的整数，并将其作为方法的返回值。
     *
     * @author DengChao
    ...
    public static int readClientNumber() {
        ...
        for (; ; ) {
            ...
            if (str.length() == 4 && firstString != '0') {
                ...
                if (!clientFirstShow) {
                    for (int i = 0; i < ClientManager.getCim().getAddCount(); i++) {
                        if (ClientManager.getCim().getCi()[i].getClientNum() == clientNumber) {
    ...
    /**
     * TODO 用于客户姓名的输入判断。该方法判断输入的姓名位数，并自动添加制表符保证查看客户信息的排版美观。
     *
     * @author DengChao
     * @date 2022/1/21 15:25
     */
    ...
    /**
     * TODO 用于手机号码的输入判断。该方法从键盘读取一个不超过11位长度的字符串，并将其作为方法的返回值。
     *
     * @author DengChao
     * @date 2022/1/21 15:25
     */
    public static String readClientPhoneNumber() {
        ...
        for (; ; ) {
            ...
            if (str.length() == 11 && str.charAt(0) == '1') {
                if (!clientFirstShow) {
                    for (int i = 0; i < ClientManager.getCim().getAddCount(); i++) {
                        if (ClientManager.getCim().getCi()[i].getClientPhoneNum().equals(str)) {
    ...
    /**
     * TODO 用于客户积分的输入判断。该方法从键盘读取一个整数，该整数不能为小于或等于0，并将其作为方法的返回值。
     *
     * @author DengChao
     * @date 2022/1/21 15:25
     */
    ...
    /**
     * TODO 删除、修改、查询客户信息时，查找输入的客户编号是否存在，存在则返回其数组中的索引位置，反之则提示重新输入
     *
     * @author DengChao
    ...
    public static int clientInformationNumExist() {
        ...
        for (; ; ) {
            ...
            for (int i = 0; i <= ClientManager.getCim().getAddCount(); i++) {
                if (ClientManager.getCim().getCi()[i].getClientNum() == clientNum) {
                    return i;
                }
            }
            if (clientNum < 0) {
    ...
    /**
     * TODO 用于购物结算时，查找输入的客户编号是否存在，存在则返回其数组中的索引位置，反之则提示重新输入
     *
     * @author DengChao
     * @date 2022/3/29 12:52
     */
    ...
    /**
     * TODO 删除、修改、查询商品信息时，查找输入的商品编号是否存在，存在则返回其数组中的索引位置，反之则提示重新输入
     *
     * @author DengChao
    ...
    public static int productInformationNumExist() {
        ...
        for (; ; ) {
            ...
            for (int i = 0; i <= ProductManager.getPm().getAddCount(); i++) {
                if (ProductManager.getPm().getPi()[i].
    ...
    /**
     * TODO 用于在添加商品输入商品编号时判断是否添加过该商品编号，从键盘读入一个整数，并将其作为方法的返回值。
     *
     * @author DengChao
     * @date 2022/1/21 15:25
     */
    public static int readProductNumber() {
        ...
        for (; ; ) {
            ...
            if (!productFirstShow) {
                for (int i = 0; i < ProductManager.getPm().getAddCount(); i++) {
                    if (ProductManager.getPm().getPi()[i].getProductNum() == productNum) {
    ...
    /**
     * TODO 用于在添加商品输入商品名称时判断是否添加过该商品名称，从键盘读入一个字符串，并将其作为方法的返回值。
     *
     * @author DengChao
    ...
    public static String readProductName() {
        ...
        for (; ; ) {
            ...
            if (!productFirstShow) {
                for (int i = 0; i < ProductManager.getPm().getAddCount(); i++) {
                    if (ProductManager.getPm().getPi()[i].getProductName().equals(name)) {
    ...
    /**
     * TODO 用于在添加商品输入商品价格时，判断输入的价格是否小于零，如果是就提示重新输入，反之则返回变量price。
     *
     * @author DengChao
     * @date 2022/1/21 15:26
     */
    ...
    /**
     * TODO 输入商品编号时，判断输入的商品编号是否存在，存在则返回该值，反之则提示重新输入。
     *
     * @author DengChao
     * @date 2022/1/21 15:26
     */
    ...
    /**
     * TODO 判断结算时输入的金额是否大于购物金额，如果大于就继续结算，反之则让客户重新输入。
     *
     * @author DengChao
     * @date 2022/1/21 15:26
     */
     ...
     *
     * @author DengChao
     * @date 2022/3/29 12:21
     */
    public static double setMoney(double money) {
        String setMoneyString = String.format("%.2f", money);
        return Double.parseDouble(setMoneyString);
    }

    /**
     * TODO 用于确认选择的输入。该方法从键盘读取‘Y’或’N’，并将其作为方法的返回值。
     *
     * @author DengChao
     * @date 2022/1/21 15:26
     */
